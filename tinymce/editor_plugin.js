...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _editor_pluginSrc = __webpack_require__(25);
	...
	module.exports = {
	    ...
	    currentInstance: _editor_pluginSrc.currentInstance,
	    instances: _editor_pluginSrc.instances,
	    TinyMceIntegration: _editor_pluginSrc.TinyMceIntegration
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.currentInstance = exports.instances = undefined;
	 ...
	 */
	var TinyMceIntegration = function (_IntegrationModel) {
	    ...
	    function TinyMceIntegration(integrationModelProperties) {
	         ...
	         * @type {boolean}
	         */
	        var _this = _possibleConstructorReturn(this, _IntegrationModel.call(this, integrationModelProperties));
	    ...
	    TinyMceIntegration.prototype.getPath = function getPath() {
	        if (this.isMoodle) {
	    ...
	    TinyMceIntegration.prototype.getIconsPath = function getIconsPath() {
	        if (this.isMoodle && _configuration2.default.get('versionPlatform') < 2013111800) {
	    ...
	    TinyMceIntegration.prototype.getLanguage = function getLanguage() {
	    ...
	    TinyMceIntegration.prototype.callbackFunction = function callbackFunction() {
	        var dataImgFiltered = [];
	        _IntegrationModel.prototype.callbackFunction.call(this);

	        // Avoid to change class of image formulas.
	        var imageClassName = _configuration2.default.get('imageClassName');
	        if (this.isIframe) {
	            // Attaching observers to wiris images.
	            if (typeof _parser2.default.observer != 'undefined') {
	                Array.prototype.forEach.call(this.target.contentDocument.getElementsByClassName(imageClassName), function (wirisImages) {
	                    _parser2.default.observer.observe(wirisImages);
	                });
	            }
	        } else {
	            // Inline.
	        ...
	        var listener = _listeners2.default.newListener('onAfterFormulaInsertion', function () {
	        ...
	        this.editorObject.settings.images_dataimg_filter = function (img) {
	            if (img.hasAttribute('class') && img.getAttribute('class').indexOf(_configuration2.default.get(imageClassName)) != -1) {
	...
	exports.default = TinyMceIntegration;
	 ...
	 */
	var currentInstance = exports.currentInstance = null;
	...
	(function () {
	    tinymce.create('tinymce.plugins.tiny_mce_wiris', {
	        init: function init(editor, url) {
	            ...
	            integrationModelProperties.version = '7.5.0.1391';
	            integrationModelProperties.isMoodle = true;
	            if (typeof editor.getParam('wiriscontextpath') !== 'undefined') {
	                integrationModelProperties.configurationService = _util2.default.concatenateUrl(editor.getParam('wiriscontextpath'), integrationModelProperties.configurationService);
	            ...
	            var onInit = function onInit(editor) {
	                ...
	                if ('wiriseditorparameters' in editor.settings) {
	                    _configuration2.default.update('_wrs_conf_editorParameters', editor.settings.wiriseditorparameters);
	                }
	                ...
	                if (!editor.getParam('fullscreen_is_enabled') && content !== "") {
	                    ...
	                    editor.setContent(_parser2.default.initParse(content, editor.getParam('language')), { format: "html" });
	            ...
	            var onSave = function onSave(editor, params) {
	                params.content = _parser2.default.endParse(params.content, editor.getParam('language'));
	            };
	            ...
	            if ('onBeforeSetContent' in editor) {
	                ...
	                editor.on('beforeSetContent', function (params) {
	                    if (WirisPlugin.currentInstance.initParsed) {
	                        params.content = _parser2.default.initParse(params.content, editor.getParam('language'));
	                    }
	                });
	            }
